...
const NewReport: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white mb-2">Buat Laporan Baru</h1>
        <p className="text-sm text-zinc-400">Laporkan kerusakan fasilitas kampus dengan detail</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="vision-pane p-10 space-y-6">
        <div>
          ...
          <input
            ...
            placeholder="Contoh: AC Rusak di Ruang 101"
        ...
        <div>
          <label className="block text-sm font-semibold text-white mb-2">Upload Foto (Opsional)</label>
          <div className="relative">
            ...
            >
              ...
              <span className="text-zinc-300 text-sm font-medium">Klik untuk upload foto</span>
